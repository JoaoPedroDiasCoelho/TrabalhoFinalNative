...
function HomeScreen() {
  ...
  return (
    ...
    <StatusBar />
    <View style={{ flex: 1 }}>
      <View style={{ width: "100%", backgroundColor: "#191919", height: 200, justifyContent: "space-around", borderBottomLeftRadius: 25, borderBottomRightRadius: 25, paddingHorizontal: 20}}>
